...
public class BookingController {
	...
	public List<Booking>  getBookingsPassenger(){
		return this.bookingService.getBookingPassenger();
	}
	@GetMapping("/booking/{bid}")
	public ResponseEntity getId(@PathVariable("bid") int id){
		return new ResponseEntity(bookingService.getId(id), HttpStatus.OK);
